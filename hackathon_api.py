...
def planSprintPrompt(workers, tickets):
    ...
    prompt += ("Could you please assign these {0} tasks to my {1} workers primarily based on their skillset "
                "and making sure not to exceed each worker's inidividual capacity. Answer should include a csv file in the format with column 1 being task number and column 2 being worker number assigned to the task. "
